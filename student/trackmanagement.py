...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        P_vel = np.matrix([[params.sigma_p44,0,0],[0,params.sigma_p55,0],[0,0,params.sigma_p66]])
...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        for track in self.track_list:
            if (track.state == 'confirmed') & (track.score < params.delete_threshold):
    ...
    def handle_updated_track(self, track):      
        ...
        if not (track.score + 1/params.window) > 1:
            track.score = track.score + 1/params.window
        if track.state == 'initialized':
            track.state = 'tentative'
        elif (track.state == 'tentative') & (track.score >= params.confirmed_threshold):
